...
namespace eSport.Migrations
{
    ...
    [Migration("20221027162804_UpdateUtakmica")]
    partial class UpdateUtakmica
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eSport.Database.Utakmica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BrojGolovaDomacina")
                        .HasColumnType("int");

                    b.Property<int>("BrojGolovaGosta")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("VrijemeUtakmice")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("eSport.Database.Utakmica", b =>
                {
                    b.HasOne("eSport.Database.Tim", "Domacin")
                        .WithMany()
                        .HasForeignKey("DomacinId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eSport.Database.Tim", "Gost")
                        .WithMany()
