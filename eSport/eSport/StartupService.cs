        ...
        public void Init(DatabaseContext context)
        {
                ...
                && x.Datum == new DateTime(2023,1,1) && x.Pocetak == new DateTime(2023,1,1, 10,0,0) && x.Kraj == new DateTime(2023,1,1,12,0,0)))
            {
                context.Termins.Add(new Termin
                {
                    ...
                    Pocetak = new DateTime(2023, 2,1,10,0,0),
                    Kraj = new DateTime(2023, 2,1,12,0,0),
                    UkupnaCijena = 60,
                    IsPotvrdjen = true,
                    IsDeleted = false,
                    CreatedAt = DateTime.Now,
               ...
               && x.Datum == new DateTime(2023, 1, 1) && x.Pocetak == new DateTime(2023, 1, 1, 12, 0, 0) && x.Kraj == new DateTime(2023, 1, 1, 15, 0, 0)))
            {
                context.Termins.Add(new Termin
                {
                    ...
                    TerenId = fudbalskiTeren1Id,
                    Datum = new DateTime(2023, 2, 1),
                    Pocetak = new DateTime(2023, 2, 1, 12, 0, 0),
                    Kraj = new DateTime(2023, 2, 1, 15, 0, 0),
                    UkupnaCijena = 60,
                    IsPotvrdjen = true,
                    IsDeleted = false,
                    CreatedAt = DateTime.Now,
            ...
            if (!context.Turnirs.Any(x => x.Naziv == "FA KUP"))
            {
                context.Turnirs.Add(new Turnir
                {
                    ...
                    TerenId = fudbalskiTeren2Id,
                    DatumPocetka = new DateTime(2023, 2, 2),
                    DatumKraja = new DateTime(2023, 2, 3),
                    VrijemePocetka = 10,
                    VrijemeKraja = 15,
                    IsGenerisan = true,
                    IsPotvrdjen = true,
            ...
            if (!context.Turnirs.Any(x => x.Naziv == "LIGA KUP"))
            {
                context.Turnirs.Add(new Turnir
                {
                    ...
                    CjenovnikId = fudbalskiTeren2DnevnaId,
                    TerenId = fudbalskiTeren2Id,
                    DatumPocetka = new DateTime(2023, 2, 4),
                    DatumKraja = new DateTime(2023, 2, 5),
                    VrijemePocetka = 10,
                    VrijemeKraja = 15,
                    IsGenerisan = false,
                    IsPotvrdjen = true,
